...
class TemplateProcessor
{
     ...
     * @param string $replaceName image filename to remove
     * @param string $addPath Path and filename of replacement image
     * @return void
     */
    public function replaceImage($replaceName, $addPath) {
        $this->zipClass->deleteName('word/media/'.$replaceName);
